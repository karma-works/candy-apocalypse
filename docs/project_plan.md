...
- **Full Game Scope**: Our goal is a fully working game. We will implement or adapt from existing BSD-compatible projects (primarily Freedoom): Sound, Music, Levels, and structural Assets.
